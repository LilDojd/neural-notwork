...
if __name__ == '__main__':
    ...
    parser.add_argument("--model-output-type", choices=['aa', 'ss'], default="ss",
                        help="Whether the model should output secondary structure or amino acid labels (default: %("
                             "default)s)")
    ...
    # Set train and validation fractions of dataset
    ...
    if options.mode == 'train':
        ...
        print(f"# Q{output_size} score (test set): {Q_test:f}")
        print(f"# loss (test set): {loss_test:f}")
